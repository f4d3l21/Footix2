...
class __TwigTemplate_10480401d06e1bdf4683a3108cf85204 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 115
        echo twig_call_macro($macros["helper"], "macro_render_table_runs", [twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 115, $this->source); })()), "runs", [0 => 2], "method", false, false, false, 115), "Deerializations"], 115, $context, $this->getSourceContext());
        echo "
...
{%- block panel -%}
    ...
    {{ helper.render_table_runs(collector.runs(2), 'Deerializations') }}
...
{%- macro render_table_runs(runs, mode) -%}
    ...
    {%- endif -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/panel.html.twig", "/Users/matteo/Dev/GithubYnov/Api/Footix2/vendor/jms/serializer-bundle/Resources/views/Collector/panel.html.twig");
    }
}
