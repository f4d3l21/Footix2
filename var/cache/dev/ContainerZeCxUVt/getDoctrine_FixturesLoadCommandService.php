...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/RecontreFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\RecontreFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\TeamFixtures(new \Symfony\Component\PasswordHasher\Hasher\UserPasswordHasher(($container->privates['security.password_hasher_factory'] ?? $container->load('getSecurity_PasswordHasherFactoryService')))), 'groups' => []]]);
