...
class getJmsSerializerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $f->addListener('serializer.post_serialize', [0 => 'hateoas.event_listener.xml', 1 => 'onPostSerialize'], NULL, 'xml', NULL);
        $f->addListener('serializer.post_serialize', [0 => 'hateoas.event_listener.json', 1 => 'onPostSerialize'], NULL, 'json', NULL);
