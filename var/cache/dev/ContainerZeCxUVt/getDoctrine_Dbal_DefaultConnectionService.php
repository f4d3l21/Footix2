...
class getDoctrine_Dbal_DefaultConnectionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['url' => $container->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'vich_uploader.listener.clean.pictures' => ['privates', 'vich_uploader.listener.clean.pictures', 'getVichUploader_Listener_Clean_PicturesService', true],
            'vich_uploader.listener.remove.pictures' => ['privates', 'vich_uploader.listener.remove.pictures', 'getVichUploader_Listener_Remove_PicturesService', true],
            'vich_uploader.listener.upload.pictures' => ['privates', 'vich_uploader.listener.upload.pictures', 'getVichUploader_Listener_Upload_PicturesService', true],
        ], [
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber' => '?',
            'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber' => '?',
            'vich_uploader.listener.clean.pictures' => '?',
            'vich_uploader.listener.remove.pictures' => '?',
            'vich_uploader.listener.upload.pictures' => '?',
        ]), [0 => 'vich_uploader.listener.clean.pictures', 1 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 2 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 3 => 'vich_uploader.listener.remove.pictures', 4 => 'vich_uploader.listener.upload.pictures', 5 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]), []);
    }
}
