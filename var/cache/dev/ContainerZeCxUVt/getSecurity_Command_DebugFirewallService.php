...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.WfO.0Vv'] ?? $container->get_ServiceLocator_WfO_0VvService()), ($container->privates['.service_locator.LAjDzTv'] ?? $container->load('get_ServiceLocator_LAjDzTvService')), ['login' => [0 => ($container->privates['security.authenticator.json_login.login'] ?? $container->load('getSecurity_Authenticator_JsonLogin_LoginService'))], 'api' => [0 => ($container->privates['security.authenticator.jwt.api'] ?? $container->load('getSecurity_Authenticator_Jwt_ApiService')), 1 => ($container->privates['security.authenticator.json_login.api'] ?? $container->load('getSecurity_Authenticator_JsonLogin_ApiService')), 2 => ($container->privates['security.authenticator.refresh_jwt.api'] ?? $container->load('getSecurity_Authenticator_RefreshJwt_ApiService'))]], false);
