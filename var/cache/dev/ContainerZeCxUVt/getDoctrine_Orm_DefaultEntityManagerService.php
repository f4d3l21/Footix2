...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = ($container->privates['doctrine.orm.default_xml_metadata_driver'] ?? $container->load('getDoctrine_Orm_DefaultXmlMetadataDriverService'));

        $b->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ?? ($container->privates['doctrine.orm.default_attribute_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([0 => (\dirname(__DIR__, 4).'/src/Entity')]))), 'App\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\Repository\\RefreshTokenRepository' => ['privates', 'App\\Repository\\RefreshTokenRepository', 'getRefreshTokenRepositoryService', true],
            'App\\Repository\\RencontreRepository' => ['privates', 'App\\Repository\\RencontreRepository', 'getRencontreRepositoryService', true],
            ...
            'App\\Repository\\RencontreRepository' => '?',
            'App\\Repository\\TeamRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
        ])));

        $instance = new \Doctrine\ORM\EntityManager(($container->services['doctrine.dbal.default_connection'] ?? $container->load('getDoctrine_Dbal_DefaultConnectionService')), $a);
