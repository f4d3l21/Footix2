...
class JmsSerializerConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     */
    public function propertyNaming(mixed $value = []): \Symfony\Config\JmsSerializer\PropertyNamingConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function expressionEvaluator(mixed $value = []): \Symfony\Config\JmsSerializer\ExpressionEvaluatorConfig|static
    {
        if (!\is_array($value)) {
