...
class InstancesConfig 
{
    ...
    */
     ...
     */
    public function propertyNaming(mixed $value = []): \Symfony\Config\JmsSerializer\InstancesConfig\PropertyNamingConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function expressionEvaluator(mixed $value = []): \Symfony\Config\JmsSerializer\InstancesConfig\ExpressionEvaluatorConfig|static
    {
        if (!\is_array($value)) {
