...
class GesdinetJwtRefreshTokenConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
     ...
     * @return $this
     */
    public function ttlUpdate($value): static
    {
     ...
     * @return $this
     */
    public function firewall($value): static
    {
     ...
     * @return $this
     */
    public function refreshTokenEntity($value): static
    {
     ...
     * @return $this
     */
    public function singleUse($value): static
    {
     ...
     * @return $this
     */
    public function tokenParameterName($value): static
    {
     ...
     * @return $this
     */
    public function doctrineMappings($value): static
    {
    ...
    /**
     * @default {"enabled":false,"same_site":"lax","path":"\/","domain":null,"http_only":true,"secure":true,"remove_token_from_body":true}
     * @return \Symfony\Config\GesdinetJwtRefreshToken\CookieConfig|$this
     */
    public function cookie(mixed $value = []): \Symfony\Config\GesdinetJwtRefreshToken\CookieConfig|static
    {
        if (!\is_array($value)) {
        ...
        if (!$this->cookie instanceof \Symfony\Config\GesdinetJwtRefreshToken\CookieConfig) {
            $this->_usedProperties['cookie'] = true;
     ...
     * @return $this
     */
    public function logoutFirewall($value): static
    {
     ...
     * @return $this
     */
    public function returnExpiration($value): static
    {
     ...
     * @return $this
     */
    public function returnExpirationParameterName($value): static
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('cookie', $value)) {
            $this->_usedProperties['cookie'] = true;
            $this->cookie = \is_array($value['cookie']) ? new \Symfony\Config\GesdinetJwtRefreshToken\CookieConfig($value['cookie']) : $value['cookie'];
            unset($value['cookie']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['cookie'])) {
            $output['cookie'] = $this->cookie instanceof \Symfony\Config\GesdinetJwtRefreshToken\CookieConfig ? $this->cookie->toArray() : $this->cookie;
        }
